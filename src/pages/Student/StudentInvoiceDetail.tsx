...
import { Printer, Download, ArrowLeft, Loader2, FileText, CheckCircle } from "lucide-react";
...
const StudentInvoiceDetail = () => {
  ...
  return (
    <DashboardLayout role="student" sidebarItems={studentSidebarItems} title="Invoice Details">
      <style>{`
        @media print {
          body * {
            visibility: hidden;
      ...
      <div className="space-y-6">
        ...
        {loading ? (
          ...
          <Card className="p-8 text-center border-dashed">
            ...
            <p className="text-gray-500 mt-2">We couldn't retrieve the invoice details for this course.</p>
          </Card>
        ) : (
...
export default StudentInvoiceDetail;
